...
public partial class AddProducts : System.Web.UI.Page
{
    ...
    private void BindBrand()
    {
        using (SqlConnection con1 = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString))
        {
            ...
            con1.Open();
            SqlCommand cmd1 = new SqlCommand("SELECT * FROM BrandNameTbl WITH (NOLOCK)", con1);
            ...
            if (dt1.Rows.Count != 0)
            {
                ...
                BrandNameDDL.DataValueField = "Id";
    ...
    private void BindCategory()
    {
        using (SqlConnection con2 = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString))
        {
            ...
            con2.Open();
            SqlCommand cmd2 = new SqlCommand("SELECT * FROM CatTbl WITH (NOLOCK)", con2);
    ...
    protected void AddProduct_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con1 = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString))
        {
            ...
            cmd1.Parameters.AddWithValue("@ProductBrandId", BrandNameDDL.SelectedItem.Value);

            cmd1.Parameters.AddWithValue("@ProductCategoryId", CategoryDDL.SelectedItem.Value);

            if (SubCategoryDDL.SelectedItem != null)
            {
                cmd1.Parameters.AddWithValue("@ProductSubCategoryId", SubCategoryDDL.SelectedItem.Value);
            }
            else
            {
                cmd1.Parameters.AddWithValue("@ProductSubCategoryId", 0);
            ...
            if (COD.Checked == true)
            {
                cmd1.Parameters.AddWithValue("@Cod", 1.ToString());

            }
            else
            {
                cmd1.Parameters.AddWithValue("@Cod", 0.ToString());

            }
            cmd1.Parameters.AddWithValue("@Stock", Stock.Text);
            ...
            if(ProductImg1.HasFile)
            {
                ...
                SqlCommand cmd2 = new SqlCommand("INSERT INTO ProductImgTbl VALUES('" + PID + "','" + ProductName.Text.ToString().Trim() + "01" + "','" + Extention + "')", con1);
            ...
            if (ProductImg2.HasFile)
            {
                ...
                SqlCommand cmd2 = new SqlCommand("INSERT INTO ProductImgTbl VALUES('" + PID + "','" + ProductName.Text.ToString().Trim() + "02" + "','" + Extention + "')", con1);
                cmd2.ExecuteNonQuery();
            }
            ...
            if (ProductImg3.HasFile)
            {
                ...
                SqlCommand cmd2 = new SqlCommand("INSERT INTO ProductImgTbl VALUES('" + PID + "','" + ProductName.Text.ToString().Trim() + "03" + "','" + Extention + "')", con1);
                cmd2.ExecuteNonQuery();
            }
            ...
            if (ProductImg4.HasFile)
            {
                ...
                SqlCommand cmd2 = new SqlCommand("INSERT INTO ProductImgTbl VALUES('" + PID + "','" + ProductName.Text.ToString().Trim() + "04" + "','" + Extention + "')", con1);
                cmd2.ExecuteNonQuery();
            }
            ...
            if (ProductImg5.HasFile)
            {
                ...
                SqlCommand cmd2 = new SqlCommand("INSERT INTO ProductImgTbl VALUES('" + PID + "','" + ProductName.Text.ToString().Trim() + "05" + "','" + Extention + "')", con1);
                cmd2.ExecuteNonQuery();
            }
            if (ProductImg6.HasFile)
            {
                ...
                SqlCommand cmd2 = new SqlCommand("INSERT INTO ProductImgTbl VALUES('" + PID + "','" + ProductName.Text.ToString().Trim() + "06" + "','" + Extention + "')", con1);
                cmd2.ExecuteNonQuery();
            }
    ...
    protected void CategoryDDL_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            using (SqlConnection con4 = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString))
            {
                ...
                con4.Open();
                SqlCommand cmd4 = new SqlCommand("SELECT * FROM SubCatTbl WHERE CatId = '" + MainId + "'", con4);
                ...
                if (dt4.Rows.Count != 0)
                {
                    ...
                    SubCategoryDDL.DataTextField = "SubCategory";
