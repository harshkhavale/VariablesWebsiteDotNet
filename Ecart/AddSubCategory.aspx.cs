...
public partial class SubCategory : System.Web.UI.Page
{
    ...
    protected void AddSubCatBtn_Click(object sender, EventArgs e)
    {
        ...
        {
            con1.Open();
            SqlCommand cmd1 = new SqlCommand("INSERT INTO SubCatTbl(SubCategory,CatId) Values(@subcatname,@catid)", con1);
    ...
    private void BindSubCatRepeater()
    {
        using (SqlConnection con3 = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString))
        {
            ...
            using (SqlCommand cmd3 = new SqlCommand("SELECT A.*,B.* FROM SubCatTbl A INNER JOIN CatTbl B ON B.CategoryId = A.CatId", con3))
            {
