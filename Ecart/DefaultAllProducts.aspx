<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="DefaultAllProducts.aspx.cs" Inherits="DefaultAllProducts" %>
            ...
            <asp:Repeater ID="productrptr" runat="server">
                <ItemTemplate>
                     ...
                     <div class="card mx-3 my-2 mb-4 crd shadow p-3 mb-5 bg-body rounded" style="width: 18rem">
                         <a href="DefaultViewMore.aspx?PID=<%#Eval("PID")%>" style="text-decoration:none;color:black" >
  <img src="Img/ProductImg/<%#Eval("PID") %>/<%# Eval("ImageName")%><%# Eval("Extention") %>" class="card-img-top h-50" alt="<%#Eval("ImageName") %>">
  <div class="card-body ">
