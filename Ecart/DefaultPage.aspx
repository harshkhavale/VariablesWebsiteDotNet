<%@ Page Title="" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="DefaultPage.aspx.cs" Inherits="DefaultPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div class=" mt-0 w-100 sticky-top" style="font-family: 'Quicksand', sans-serif; z-index:3">
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
   
    <div class="carousel-inner " style="max-height:58vh;font-family: 'Quicksand', sans-serif;">
     
      <div class="carousel-item active d-flex justify-content-center" >
          <img src="img/Advertisements/appleAdd1.png" class="w-100" />
      
      </div>
      <div class="carousel-item" >
          <img src="img/Advertisements/appleAdd4.png" class="w-100" />
                 
      </div>
          <div class="carousel-item" >
          <img src="img/Advertisements/appleAdd3.png" class="w-100" />
   ...
   <div class="bg-light  h-100 w-100 row d-flex p-0 m-0 sticky-top" >
        <div class="col-6 p-0" >
           <div class=" d-flex justify-content-center text-dark carousel-item m-0">
        ...
        <h1 class="">boAt Wave Call Smart Watch</h1>
            <h4 class="">let it be !</h4>
              ...
              <br />
                   <a href="SignInPage.aspx" class="text-center mx-4 link-primary">Buy Now </a>
                   <a href="DefaultViewMore.aspx?PID=17" class="text-center mx-4 link-primary"> ViewMore</a>
        ...
        <div class="col-6 p-0" style="background-color:black"  >
          ...
          <div class=" text-end  text-light text-center">
            ...
            <h4 class="">Music in blood</h4>
              ...
              <br />
                   <a href="SignInPage.aspx" class="text-center mx-4 link-primary">Buy Now </a>
                   <a href="DefaultViewMore.aspx?PID=16" class="text-center mx-4 link-primary"> ViewMore</a>
            ...
            <div class="col-8 d-flex justify-content-center" style="background-color:black;overflow:hidden">
             <img src="img/Advertisements/iphone14proadd.jpg" class="addimg h-75 mt-4" />
                </div>
          ...
          <div class=" text-end bg-light text-dark text-center">
            ...
            <h4 class="">Go Beyond</h4>
              ...
              <br />
                    <a href="SignInPage.aspx" class="text-center mx-4 link-primary">Buy Now </a>
                   <a href="DefaultViewMore.aspx?PID=18" class="text-center mx-4 link-primary"> ViewMore</a>
       ...
       <div class="container my-4 sticky-top" style="font-family: 'Quicksand', sans-serif;z-index:8">



                            <h5 class="badge bg-warning mb-0 ">NEW</h5>                                                                                    
           <a href="DefaultAllProducts.aspx" class="text-center btn rounded-0 btn-primary mx-4">VIEW ALL </a>
  ...
  <div class="card-body ">
    ...
    <h4 class="badge bg-primary">Save ₹  <%#String.Format("{0}",Convert.ToInt64(Eval("ProductPrice"))-Convert.ToInt64(Eval("ProductSellingPrice")))%></h4>
         ...
         <div class="p-0  h-100 bg-light w-100 mt-0 d-flex justify-content-center sticky-top m-0 "  style="font-family: 'Quicksand', sans-serif;z-index:10">
          ...
          <div class=" text-end  text-dark bg-light text-center">
            ...
            <h4 class="">Creativity on your PALMS</h4>
              ...
              <br />
                    <a href="SignInPage.aspx" class="text-center mx-4 link-primary">Buy Now </a>
                   <a href="DefaultViewMore.aspx?PID=19" class="text-center mx-4 link-primary"> ViewMore</a>

          </div>
        </div>
             
            <div class="col-8 d-flex justify-content-center" style="background-color:black;overflow:hidden">
                 <img src="img/Advertisements/appletabletadd.jpg" class="addimg h-75 mt-4" style="padding-top:20vh" /> 
