<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="ProductsShow.aspx.cs" Inherits="ProductsShow" %>
            ...
            <asp:Repeater ID="productrptr" runat="server">
                <ItemTemplate>
                     ...
                     <div class="card mx-3 my-2 mb-4 crd shadow p-3 mb-5 bg-body rounded" style="width: 18rem">
                         <a href="ViewMore.aspx?PID=<%#Eval("PID")%>" style="text-decoration:none;color:black" >
