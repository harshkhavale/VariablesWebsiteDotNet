...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class=" mt-0 w-100 sticky-top" style="font-family: 'Quicksand', sans-serif; z-index:4">
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
   
    <div class="carousel-inner " style="max-height:58vh;font-family: 'Quicksand', sans-serif;">
     
      <div class="carousel-item active" class="d-flex justify-content-center" >
    ...
    <button class="carousel-control-next" type="button" data-bs-target="#myCarousel" data-bs-slide="next">
      ...
      <span class="visually-hidden">Next</span>
       ...
       <div class="container my-4 sticky-top "  style="font-family: 'Quicksand', sans-serif;z-index:5;margin-top:0;margin-bottom:0">
                                                       <h5 style="font-size:large" class="badge bg-success rounded-0 my-2 ">NEW ARRIVAL'S</h5>
...
<br />
 ...
 <div class="sticky-top"  style="font-family: 'Quicksand', sans-serif;z-index:6">
   <div class="bg-light w-100 row d-flex p-0 m-0 sticky-top" style="z-index:5" >
        <div class="col-6 p-0" >
          ...
          <div class=" text-end text-dark text-center">
        ...
        <div class="col-6 p-0" style="background-color:black" >
         ...
         <div class="mb-0 d-flex  h-100 w-100 bg-light sticky-top justify-content-center p-0 m-0"  style="font-family: 'Quicksand', sans-serif;z-index:7">
            <div class="col-8 d-flex justify-content-center" style="background-color:black;overflow:hidden">
             <img src="img/Advertisements/iphone14proadd.jpg" class="addimg h-75 pt-4" />
                </div>
         ...
         <div class="p-0  h-100 bg-light w-100 mt-0 d-flex justify-content-center sticky-top m-0 "  style="font-family: 'Quicksand', sans-serif;margin-top:0;padding-top:0;z-index:8">
          ...
          <div class=" text-end  text-dark bg-light text-center">
            ...
            <div class="col-8 d-flex justify-content-center" style="background-color:black;overflow:hidden">
                 <img src="img/Advertisements/appletabletadd.jpg" class="addimg h-75" style="padding-top:20vh"/> 
