<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="ViewMore.aspx.cs" Inherits="ViewMore" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <div class=" my-4 mx-4 mb-0 pb-0" style="font-family: 'Quicksand', sans-serif;">
        <div class="d-flex ">
                
            <div id="carouselExampleIndicators" class="carousel  slide w-50" data-bs-ride="true" style="min-height:100vh" >
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
    ...
    <h2 class="card-title"><%#Eval("ProductName") %></h2>
             ...
             <div class="container my-2 mx-2 w-25 h-25 border rounded-4 text-center " >
